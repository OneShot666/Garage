...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=242044156ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=garage&table=voiture">`garage`.`voiture`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=garage&table=admin">`garage`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=phpmyadmin&table=pma__bookmark">`phpmyadmin`.`pma__bookmark`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=garage&table=Voiture">`garage`.`Voiture`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="394a6e372f67215b473871677678584d">
...
</span><small>Définir à 0 pour replier le panneau de navigation.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="241"><a class="restore-default hide" href="#NavigationWidth" title="Restaurer la valeur par défaut"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="garage" targettable="voiture">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `voiture` (`marque`, `modèle`, `numéro d&#039;immatriculation`, `date first mise en circulation`, `prix`, `date rentrée garage`, `description`, `nb chevaux`) VALUES (&#039;Renault&#039;, &#039;Captur&#039;, &#039;&#039;, &#039;2014-12-23&#039;, &#039;21560&#039;, &#039;2019-04-17&#039;, &#039;&#039;, &#039;90&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `voiture` (`marque`, `modèle`, `numéro d&#039;immatriculation`, `date first mise en circulation`, `prix`, `date rentrée garage`, `description`, `nb chevaux`) VALUES (&#039;Suzuki&#039;, &#039;Swift&#039;, &#039;FR 2024&#039;, &#039;2012-10-06&#039;, &#039;14999&#039;, &#039;2017-06-28&#039;, &#039;&#039;, &#039;85&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `voiture` (`marque`, `modèle`, `numéro d&#039;immatriculation`, `date first mise en circulation`, `prix`, `date rentrée garage`, `description`, `nb chevaux`) VALUES (&#039;Suzuki&#039;, &#039;Across&#039;, &#039;FR 9051&#039;, &#039;2018-08-24&#039;, &#039;47999&#039;, &#039;2021-07-13&#039;, &#039;&#039;, &#039;180&#039;);</span>
                        </div>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `voiture`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `voiture`  
ORDER BY `voiture`.`nb chevaux` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `voiture`  
ORDER BY `voiture`.`prix` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="phpmyadmin" targettable="pma__bookmark">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `pma__bookmark`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT *  FROM `voiture` WHERE `marque` LIKE &#039;Renault&#039; AND `modèle` LIKE &#039;Captur&#039; ORDER BY `prix` ASC </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `voiture`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="garage" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `garage`.`admin` ( `speudonyme` VARCHAR(255) NOT NULL ,  `password` VARCHAR(255) NOT NULL ,  `mail` VARCHAR(255) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="admin">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">INSERT INTO `admin` (`speudonyme`, `password`, `mail`) VALUES (&#039;One Shot&#039;, &#039;mongarage42&#039;, &#039;mir.nathan42@gmail.com&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="admin">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `voiture`  
ORDER BY `voiture`.`date rentrée garage` DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `voiture`  
ORDER BY `voiture`.`date rentrée garage`  ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="garage" targettable="voiture">
                            <div class="action_content">
...
ORDER BY `voiture`.`date rentrée garage`  ASC</span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `voiture` WHERE 1;</span>
                        </div>
