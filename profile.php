...
>>>>>>> de35599262b94eb2251ba41078ff191e9fea0818
        ...
        <div class="formulaire" style="color: rgb(22, 22, 22); text-align: left; width: 80%;" id="profile">
            <?php
                if ($is_admin) $image_name = (file_exists("img/admin/".$_SESSION['id'].".jpg")) ?
                    "img/admin/".$_SESSION['id'].".jpg" : "img/admin/default.jpg";
                else $image_name = (file_exists("img/user/".$_SESSION['id'].".jpg")) ?
                    "img/user/".$_SESSION['id'].".jpg" : "img/user/default.jpg";
                    ...
                    if (count($fav) > 0 and $fav[0] != "0") {                   // Si au moins un favoris
                        foreach ($fav as $key => $value) {
                            ...
                            $nom_image = "car-".strtolower($database[0]['brand'])."-".
                                                strtolower($database[0]['model'])."-fr ".
                                                strtolower($database[0]["numberplate"]).".jpg";
                            if (! file_exists("img/car/".$nom_image)) {      // Si ne trouve pas l'image
                                $nom_image = "car-".strtolower($database[0]['brand'])."-".
                                                    strtolower($database[0]['model'])."-fr 0000.jpg";
                            }
                            if (! file_exists("img/car/".$nom_image)) {      // Si ne trouve toujours pas l'image
                                $nom_image = "icon.svg";
                            }
                            $nom_image = "img/car/".$nom_image;
>>>>>>> de35599262b94eb2251ba41078ff191e9fea0818
